...
TipoBase Pila::SacarValor () {
	...
	if (p->sig == 0) {
		// Este caso es para cuando solo quede un valor en la pila
		valor = p->valor;
		pila=0;
...
Pila & Pila::operator += (TipoBase value) {
...
/*****************************************************************************/
// Sobrecarga del operador unario -- (cuando se usa --pila)
...
TipoBase Pila::operator ^ (TipoBase value) {

	// Consultamos el ultimo valor de la pila (no se modifica la misma)
