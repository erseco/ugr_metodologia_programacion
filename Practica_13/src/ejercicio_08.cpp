...
void copia(istream & entrada, ostream & salida) {
	...
	int buffer [TAM_BUFFER / sizeof(int)];    // Buffer de lectura
    ...
    salida.write (reinterpret_cast<char*>(buffer), i * sizeof(int)); 
